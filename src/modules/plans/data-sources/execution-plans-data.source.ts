...
import { ExecutionPlan, ExecutionPlanFacade, PageResponse } from 'spline-api'
import { SearchDataSource, SearchQuery } from 'spline-utils'


export class ExecutionPlansDataSource extends SearchDataSource<ExecutionPlan> {
    ...
    protected getDataObserver(
        ...
        force: boolean,
    ): Observable<PageResponse<ExecutionPlan>> {
