...
import { AttributeFacade } from 'spline-api'
...
export class AttributeSearchDataSource extends SimpleDataSource<SplineAttributeSearch.Data, AttributeSearchDataSourceFilter> {
