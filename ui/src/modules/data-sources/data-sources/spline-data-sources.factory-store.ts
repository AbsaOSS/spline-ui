...
export class SplineDataSourcesFactoryStore extends SearchFactoryStore<ExecutionEvent,
    ExecutionEventsPageResponse,
    ExecutionEventsQuery.QueryFilter,
    ExecutionEventField> {

    constructor(
        protected readonly executionEventApiService: ExecutionEventApiService,
    ...
    protected getDataObserver(
        ...
        return this.executionEventApiService.fetchListAggregatedByDataSource(queryParams)
    }
