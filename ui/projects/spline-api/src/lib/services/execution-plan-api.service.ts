...
@Injectable()
export class ExecutionPlanApiService extends BaseApiService {
    ...
    fetchExecutionPlanDetails(executionPlanId: string): Observable<ExecutionPlanLineageOverview> {
        ...
        const url = this.getConsumerApiResourceURL('lineage-detailed')
    ...
    fetchOperationDetails(operationId: string): Observable<OperationDetails> {
        const url = this.getConsumerApiResourceURL(`operations/${ operationId }`)
    ...
    fetchExecutionPlanRootOperationDetails(executionPlanId: string): Observable<OperationDetails> {
        const url = this.getConsumerApiResourceURL(`execution-plans/${ executionPlanId }/write-op`)
        return this.http.get<OperationDetailsDto>(url)
            .pipe(
                map(toOperationDetails),
                catchError(error => {
    ...
    fetchAttributeLineage(executionPlanId: string, attributeId: string): Observable<OperationAttributeLineage> {
        ...
        const url = this.getConsumerApiResourceURL('attribute-lineage-and-impact')
