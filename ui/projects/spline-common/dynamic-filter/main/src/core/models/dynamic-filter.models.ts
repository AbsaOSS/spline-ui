...
import {
    ...
    DynamicFilterItemValue,
    IDynamicFilterControlModel
} from './dynamic-filter-control.models'


export type DynamicFilterValue<TFilter extends Record<string, any> = Record<string, unknown>> = {
    [K in keyof TFilter]: DynamicFilterItemValue<TFilter[K]> | null;
};

export class DynamicFilterModel<TFilter extends Record<string, any> = Record<string, unknown>> {
